...
<main>
    ...
    <div class="p-4 bg-white">
        ...
        <div class=" grid w-full grid-cols-3 gap-4 xl:grid-cols-3 2xl:grid-cols-3">
            <div class="items-center justify-between p-8 bg-[#FFD66E] border border-gray-200 rounded-lg shadow-sm sm:flex ">
                <span class="flex justify-center items-center">
                    <svg width="40px" height="40px" class="text-center" viewBox="0 0 8.4666669 8.4666669" id="svg8" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" xmlns:svg="http://www.w3.org/2000/svg">
            ...
            <div class="items-center justify-between p-8 bg-[#FFD66E] border border-gray-200 rounded-lg shadow-sm sm:flex ">
                <span class="flex justify-center items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50px" height="50px" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:serif="http://www.serif.com/" viewBox="0 0 100 125" version="1.1" xml:space="preserve" style="" x="0px" y="0px" fill-rule="evenodd" clip-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2">
                        <g>
                            <path d="M43.953,76.471c0.031,0.172 0.047,0.349 0.047,0.529c0,1.656 -1.344,3 -3,3l-15,-0c-1.656,-0 -3,-1.344 -3,-3c0,-1.656 1.344,-3 3,-3l14.292,-0c-1.426,-1.593 -2.292,-3.695 -2.292,-6l0,-8.485c0,-2.387 0.948,-4.676 2.636,-6.364l26.636,-26.636c0.235,-0.236 0.478,-0.459 0.728,-0.671l0,-8.844c0,-4.967 -4.033,-9 -9,-9l-36,-0c-4.967,-0 -9,4.033 -9,9c0,-0 0,66 0,66c0,4.967 4.033,9 9,9c0,-0 36,-0 36,-0c4.967,-0 9,-4.033 9,-9l0,-14.787l-6.151,6.151c-1.688,1.688 -3.977,2.636 -6.364,2.636c0,-0 -8.485,-0 -8.485,-0c-1.069,-0 -2.095,-0.186 -3.047,-0.529Zm-17.953,-8.471l6,-0c1.656,-0 3,-1.344 3,-3c0,-1.656 -1.344,-3 -3,-3l-6,-0c-1.656,-0 -3,1.344 -3,3c0,1.656 1.344,3 3,3Zm0,-18l12,-0c1.656,-0 3,-1.344 3,-3c0,-1.656 -1.344,-3 -3,-3l-12,-0c-1.656,-0 -3,1.344 -3,3c0,1.656 1.344,3 3,3Zm0,-12l24,-0c1.656,-0 3,-1.344 3,-3c0,-1.656 -1.344,-3 -3,-3l-24,-0c-1.656,-0 -3,1.344 -3,3c0,1.656 1.344,3 3,3Zm0,-12l24,-0c1.656,-0 3,-1.344 3,-3c0,-1.656 -1.344,-3 -3,-3l-24,-0c-1.656,-0 -3,1.344 -3,3c0,1.656 1.344,3 3,3Z" />
                            <path d="M62.515,39.757l-17.636,17.636c-0.563,0.563 -0.879,1.326 -0.879,2.122l0,8.485c0,1.657 1.343,3 3,3l8.485,-0c0.796,-0 1.559,-0.316 2.122,-0.879l17.636,-17.636l-12.728,-12.728Zm4.242,-4.242l12.728,12.728l4.758,-4.758c2.343,-2.343 2.343,-6.142 -0,-8.485l-4.243,-4.243c-2.343,-2.343 -6.142,-2.343 -8.485,0l-4.758,4.758Z" />
                        </g>
                    </svg>
                </span>
                <div class="w-full text-center">
            ...
            <div class="items-center justify-between p-10  bg-[#FFD66E] border border-gray-200 rounded-lg shadow-sm sm:flex ">
                <span class="flex justify-center items-center">
                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="35px" height="35px" +++++++++++++++++++ viewBox="0 0 512 512" xml:space="preserve">
                        <g>
    ...
    <div class="p-4 pb-0 bg-white border border-gray-200 rounded-lg shadow-sm ">
        <!-- Table -->
