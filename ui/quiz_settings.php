  ...
  <div class="p-4 bg-white block sm:flex items-center justify-between  lg:mt-1.5 ">
    <div class="w-full mb-1">
      <div class="mb-4">
        ...
        <span class="text-base font-normal text-gray-500 ">Change the settings for <span class="text-base text-gray-500 font-bold"><?php echo $quiz_name; ?></span></span>
      </div>
              ...
              <form method="GET" action="quiz_settings.php">
                <div class="mb-4">
                  ...
                  <div class="flex items-center mb-2">
                    <input type="checkbox" id="tabSwitching" name="enable_monitor_tab_switching" value="1" class="mr-2" <?php
                  ...
                  <div class="flex items-center mb-2">
                    <input type="checkbox" id="camera" name="enable_monitor_camera" value="1" class="mr-2" <?php
                  ...
                  <div class="flex items-center mb-2">
                    <input type="checkbox" id="microphone" class="mr-2" name="enable_monitor_microphone" value="1" <?php
                  ...
                  <div class="flex items-center mb-2">
                    <input type="checkbox" id="strictMode" class="mr-2" name="enable_strict_mode" value="1" <?php
                                                                                                            // Get monitor_microphone activation value
                                                                                                            // If the activation value is 1, then check the box.
                ...
                <div class="flex justify-start">
                  <button class="bg-blue-700 hover:bg-blue-900 text-white px-4 py-2 rounded-md mr-2" name="save_btn">Save</button>
                  <button id="cancelQuizSettings" class="bg-gray-300 hover:bg-gray-500 text-black px-4 py-2 rounded-md">Cancel</button>
                </div>
              </form>
            </div>
          </div>
